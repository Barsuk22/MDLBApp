...
object ChatRepository {
    ...
    data class ChatPresence(
        val lastDeliveredAt: com.google.firebase.Timestamp? = null,
        val lastReadAt: com.google.firebase.Timestamp? = null,
    ...
    suspend fun markDelivered(mommyUid: String, babyUid: String, uid: String) {
        participantsCol(mommyUid, babyUid).document(uid)
            .set(mapOf("lastDeliveredAt" to com.google.firebase.firestore.FieldValue.serverTimestamp()),
                SetOptions.merge()
            ).await()
    }
    ...
    suspend fun markRead(mommyUid: String, babyUid: String, uid: String) {
        participantsCol(mommyUid, babyUid).document(uid)
            .set(mapOf("lastReadAt" to com.google.firebase.firestore.FieldValue.serverTimestamp()),
                SetOptions.merge()
            ).await()
    }
