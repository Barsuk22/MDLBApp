...
//    val textColorMain = Color(0xFF000000)
    ...
    LaunchedEffect(Unit) {
        ...
        Firebase.firestore.collection("users").document(babyUid).get()
            .addOnSuccessListener { doc ->
                ...
                babyZone = runCatching { ZoneId.of(tz ?: "") }.getOrNull() ?: ZoneId.systemDefault()
            }
    }
            ...
            val registration = Firebase.firestore
                ...
                .addSnapshotListener { snapshots, error ->
                    ...
                    snapshots?.documents?.forEach { doc ->
                        ...
                        babyZone?.let { z ->
                            HabitDeadlineScheduler.scheduleForHabit(ctx, habitMap, z)
                        }
                    }
                }
    ...
    LaunchedEffect(babyZone) {
        babyZone?.let { z ->
            HabitDeadlineScheduler.rescheduleAllForToday(ctx, z)
        }
    }
    ...
    Box(modifier = Modifier.fillMaxSize()) {
        Column(
            ...
            if (babyZone == null) {
                Text(
                    text = stringResource(R.string.uid_loading),
                    fontStyle = FontStyle.Italic,
