...
import com.app.mdlbapp.data.AtomicUpdates
...
@Composable
fun BabyHabitCard(habit: Map<String, Any>, babyZone: ZoneId, onCompleted: () -> Unit) {
    ...
    val nowTime      = LocalTime.now(babyZone)
    ...
    val isToday       = scheduledDate == LocalDate.now(babyZone)
